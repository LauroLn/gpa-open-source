...
- Melhora na qualidade visual das telas  
- Maior clareza e fluidez  
...
- Melhoria completa da tela de Finanças  
- Criação da página de Balanço  
- Opção de visualização e troca entre PDFs  
- Interface mais clara, facilitando a navegação do cliente  
